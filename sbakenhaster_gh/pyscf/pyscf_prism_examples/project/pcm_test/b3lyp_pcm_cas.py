...
mf = scf.RKS(mol).density_fit("aug-cc-pvdz-jkfit").PCM()
mf.with_solvent.method = 'IEF-PCM'
mf.with_solvent.eps = 4.00
mf.xc = 'b3lyp'
mf.conv_tol = 1e-8
mf.kernel()
...
mc = mcscf.CASSCF(mf, 6, 6).state_average_(weights).density_fit('aug-cc-pvdz-jkfit').PCM()
mc.with_solvent.method = 'IEF-PCM'
mc.with_solvent.eps = 4.00
...
mc = mcscf.CASCI(mf, 6, 6).density_fit('aug-cc-pvdz-jkfit').PCM()
mc.with_solvent.method = 'IEF-PCM'
mc.with_solvent.eps = 4.00
mc.fix_spin_(ss=0) # Singlet states only
